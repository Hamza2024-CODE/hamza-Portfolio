...
<main class="min-h-screen bg-slate-50 dark:bg-[#0d1527] font-body text-slate-800 dark:text-slate-200 py-16 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
    <div class="max-w-5xl mx-auto space-y-12 text-left rtl:text-right">
        ...
        <header class="bg-white dark:bg-slate-900 rounded-[32px] p-8 sm:p-12 border border-slate-200/80 dark:border-white/5 shadow-xl transition-all duration-300">
            ...
            <h1 class="font-sans font-bold text-3xl sm:text-5xl text-slate-900 dark:text-white tracking-tight mb-4 leading-tight">
                حمزة بوبكر الصديق
            </h1>
            ...
            <div class="flex flex-wrap gap-4 mt-8 pt-6 border-t border-slate-100 dark:border-white/5 text-xs font-medium text-slate-600 dark:text-slate-400">
                <span class="flex items-center gap-1.5"><i class="fas fa-map-marker-alt text-teal-600"></i> الجزائر العاصمة</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-[32px] p-8 border border-slate-200/80 dark:border-white/5 shadow-xl">
                    <h2 class="font-sans font-bold text-2xl text-slate-900 dark:text-white mb-6 flex items-center gap-3" data-ar="<i class='fas fa-briefcase text-teal-600'></i> الخبرة المهنية" data-en="<i class='fas fa-briefcase text-teal-600'></i> Professional Experience">
                        <i class="fas fa-briefcase text-teal-600"></i> الخبرة المهنية
                    </h2>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="relative pr-6 border-r-2 border-teal-500/40 rtl:pr-6 rtl:border-r-2 ltr:pl-6 ltr:border-l-2">
                            ...
                            <span class="text-xs font-semibold text-teal-600 dark:text-teal-400 uppercase tracking-wider">2026 – الحاضر</span>
                            <h3 class="font-sans font-bold text-lg text-slate-900 dark:text-white mt-1">مهندس برمجيات ومطور متعدد المنصات</h3>
                            <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 mb-3">وزارة التكوين والتعليم المهنيين (MFEP) | الجزائر</p>
                            <ul class="list-disc list-inside space-y-1.5 text-xs sm:text-sm text-slate-600 dark:text-slate-300">
                                <li>تطوير المنصات المؤسسية، الأنظمة المتكاملة، واجهات الـ APIs، والحلول متعددة المنصات.</li>
                                <li>قيادة الهيكلية البرمجية، الأمن السيبراني، البنية التحتية، وتحسين أداء المنصات الحكومية.</li>
                            </ul>
                        </div>
                        ...
                        <div class="relative pr-6 border-r-2 border-teal-500/40 rtl:pr-6 rtl:border-r-2 ltr:pl-6 ltr:border-l-2">
                            <span class="absolute -right-[9px] top-0 w-4 h-4 rounded-full bg-teal-600"></span>
                            <span class="text-xs font-semibold text-teal-600 dark:text-teal-400 uppercase tracking-wider">2023 – 2026</span>
                            <h3 class="font-sans font-bold text-lg text-slate-900 dark:text-white mt-1">مهندس برمجيات / مطور أنظمة</h3>
                            <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 mb-3">مديرية التكوين والتعليم المهنيين (DEFP) | سعيدة، الجزائر</p>
                            <ul class="list-disc list-inside space-y-1.5 text-xs sm:text-sm text-slate-600 dark:text-slate-300">
                                <li>تطوير المنصات الإدارية، واجهات الـ REST APIs، ولوحات التحكم التفاعلية للمؤسسات.</li>
                                <li>تحديث الأنظمة القديمة وأتمتة الإجراءات الإدارية بالمديريات الولائية.</li>
                            </ul>
                        </div>
                        ...
                        <div class="relative pr-6 border-r-2 border-teal-500/40 rtl:pr-6 rtl:border-r-2 ltr:pl-6 ltr:border-l-2">
                            <span class="absolute -right-[9px] top-0 w-4 h-4 rounded-full bg-teal-600"></span>
                            <span class="text-xs font-semibold text-teal-600 dark:text-teal-400 uppercase tracking-wider">2019 – 2023</span>
                            <h3 class="font-sans font-bold text-lg text-slate-900 dark:text-white mt-1">مطور برمجيات وحلول رقمية</h3>
                            <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 mb-3">خبرة التطوير المستقل والمؤسسي | الجزائر</p>
                            <ul class="list-disc list-inside space-y-1.5 text-xs sm:text-sm text-slate-600 dark:text-slate-300">
                                <li>إنجاز تطبيقات الويب والموبايل والحلول البرمجية من الفكرة إلى الإنتاج النهائي.</li>
                                <li>تطوير واجهات برمجة التطبيقات APIs، قواعد البيانات، وتطبيقات الويب التقدمية PWA.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-[32px] p-8 border border-slate-200/80 dark:border-white/5 shadow-xl">
                    <h2 class="font-sans font-bold text-2xl text-slate-900 dark:text-white mb-6 flex items-center gap-3" data-ar="<i class='fas fa-graduation-cap text-teal-600'></i> التعليم والشهادات" data-en="<i class='fas fa-graduation-cap text-teal-600'></i> Education & Certifications">
                        <i class="fas fa-graduation-cap text-teal-600"></i> التعليم والشهادات
                    </h2>
                    
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs sm:text-sm">
                        <div class="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200/60 dark:border-white/5">
                            <span class="font-bold text-slate-900 dark:text-white block mb-1">الشهادة الجامعية العليا</span>
                            <span class="text-teal-600 font-semibold block mb-1">تقني سامي & ماستر 2 في الإعلام الآلي</span>
                            <p class="text-slate-500 dark:text-slate-400">تخصص تطوير البرمجيات والأنظمة الرقمية.</p>
                        </div>

                        <div class="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200/60 dark:border-white/5">
                            <span class="font-bold text-slate-900 dark:text-white block mb-1">المركز الأول في الهاكاثون (2026)</span>
                            <span class="text-teal-600 font-semibold block mb-1">المرتبة الأولى في مسابقة التطوير</span>
                            <p class="text-slate-500 dark:text-slate-400">الفائز بالمركز الأول لحل برمجيات التحول الرقمي السريع.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-[32px] p-8 border border-slate-200/80 dark:border-white/5 shadow-xl">
                    <h2 class="font-sans font-bold text-xl text-slate-900 dark:text-white mb-6 flex items-center gap-2.5" data-ar="<i class='fas fa-laptop-code text-teal-600'></i> المهارات التقنية" data-en="<i class='fas fa-laptop-code text-teal-600'></i> Technical Skills">
                        <i class="fas fa-laptop-code text-teal-600"></i> المهارات التقنية
                    </h2>
                    
                    <div class="space-y-4 font-sans text-xs">
                        <div>
                            <span class="font-bold text-slate-700 dark:text-slate-300 block mb-2">لغات البرمجة</span>
                        ...
                        <div>
                            <span class="font-bold text-slate-700 dark:text-slate-300 block mb-2">أطر العمل والتقنيات</span>
                            <div class="flex flex-wrap gap-1.5">
                        ...
                        <div>
                            <span class="font-bold text-slate-700 dark:text-slate-300 block mb-2">قواعد البيانات والسيرفرات</span>
                            <div class="flex flex-wrap gap-1.5">
